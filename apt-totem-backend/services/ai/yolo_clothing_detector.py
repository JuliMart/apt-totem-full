...
class YOLOClothingDetector:
    ...
    def _rgb_to_color_name(self, rgb_color) -> str:
        ...
        color_ranges = {
            ...
            "marrón claro": [(150, 100, 50), (200, 150, 100)],
            "marrón oscuro": [(50, 25, 0), (100, 75, 50)],
